While developing TicText, some features had to be dropped. Here are some features that, if given time, we would have loved to implement to enhance the user's experience.
