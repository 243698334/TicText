...
\author{Terrence Katzenbaer, Kevin Chen, Jack Arendt, Chengkan Huang, Georgy Petukhov}
...
\begin{enumerate}
\item Your document must have a table of contents.
\item All class, method names, code must be in monospace font. Use a font like Courier, Monaco, etc
\item All figures must be labeled.
\item Do not draw the diagrams by hand – use a diagraming tool.
\item All pages must be numbered.
\item Your documentation should follow consistent formatting for sections, headers, etc., for the entire document.
...
\input{sections/whatis}

% Formal Software Development Process
\clearpage
\section{Formal Software Development Process}
\input{sections/development_process}

% Requirements & Specifications
\clearpage
\section{Requirements \& Specifications}
\input{sections/requirements_specifications}

% Architecture & Design
\clearpage
\section{Architecture \& Design}
\input{sections/architecture_design}

% Future Plans
\clearpage
\section{Future Plans}
\input{sections/future_plans}
